...
const MaquillageProPage = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Maquillage professionnel pour vos photos",
      duration: "2h",
      price: "120€",
      features: [
        "Maquillage photo-ready",
        "Retouches entre prises",
        "Adaptation à l'éclairage",
        "Produits non réfléchissants"
      ]
    },
    {
